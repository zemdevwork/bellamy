        ...
        <div className="flex justify-between items-center px-4 md:px-12 py-3 md:py-4 border-b" style={{ borderColor: "#F0E5E9" }}>
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              aria-label="Cart"
            >
              <svg className="h-5 w-5" fill="none" stroke={brand.primary} strokeWidth={1.8} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2 9m12-9l2 9m-6-4a2 2 0 100-4 2 2 0 000 4z" />
              </svg>
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 text-[10px] font-bold px-1.5 py-0.5 rounded-full text-white" style={{ backgroundColor: brand.primary }}>
                  {cartCount}
                </span>
              )}
            </Link>
