        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative group">
            {typeof window !== "undefined" && localStorage.getItem("user") ? (
              <>
                {/* Show first letter */}
                <div className="w-8 h-8 flex items-center justify-center rounded-full bg-blue-900 text-white font-bold cursor-pointer">
                  {JSON.parse(localStorage.getItem("user")!).name?.[0]?.toUpperCase() || "U"}
                </div>
                {/* Dropdown */}
                <div className="absolute right-0 mt-2 w-40 bg-white shadow-lg border border-gray-100 rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <ul className="py-2 text-sm text-gray-700">
                    <li>
                      <Link
                        href="/user-profile"
                        className="block px-4 py-2 hover:bg-gray-100 hover:text-blue-900"
                      >
                        Profile
                      </Link>
                    </li>
                    <li>
                      <button
                        ...
                        className="w-full text-left px-4 py-2 hover:bg-gray-100 hover:text-blue-900"
                      >
                        Logout
                      </button>
                    </li>
